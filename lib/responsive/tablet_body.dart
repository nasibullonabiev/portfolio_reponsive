            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Hello. My name is",style: TextStyle(color: blue2,fontWeight: FontWeight.w800,fontSize: 20),),

                    const SizedBox(height: 100,),
                    const Text("Nabiev",style: TextStyle(color: white,fontWeight: FontWeight.bold,fontSize: 30),),
                    const Text("Nasibullo",style: TextStyle(color: white,fontWeight: FontWeight.bold,fontSize: 30),),
